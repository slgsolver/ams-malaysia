...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, type: "website", locale: "en_MY", images: [{ url: `${origin}/og-v2.png`, width: 1731, height: 909, alt: "CukaiMate Malaysia receipt-to-tax-ready workflow" }] },
