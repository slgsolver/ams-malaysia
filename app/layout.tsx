...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, type: "website", locale: "en_MY", images: [{ url: `${origin}/og-v6.png`, width: 1732, height: 908, alt: "CukaiMate Malaysia automatically fills editable Borang BE and Borang B checklist amounts from receipts" }] },
