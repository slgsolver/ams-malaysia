...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, type: "website", locale: "en_MY", images: [{ url: `${origin}/og-v5.png`, width: 1734, height: 907, alt: "CukaiMate Malaysia bilingual Chinese and English Borang BE and Borang B records" }] },
