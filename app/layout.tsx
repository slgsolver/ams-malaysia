...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, type: "website", locale: "en_MY", images: [{ url: `${origin}/og.png`, width: 1744, height: 877, alt: "CukaiMate Malaysia receipt and tax record dashboard" }] },
