...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description, type: "website", locale: "en_MY", images: [{ url: `${origin}/og-v3.png`, width: 1731, height: 909, alt: "CukaiMate Malaysia separate personal and business accounts" }] },
